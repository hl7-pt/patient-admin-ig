...
| Active as of 2025-12-08 | *Computable Name*:PTPatient |
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://example.com/fhir/hl7pt/StructureDefinition/birthplace-pt"
            ]
          }
        ],
        "mustSupport" : true
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://example.com/fhir/hl7pt/StructureDefinition/nationality-pt"
            ]
          }
        ],
        "mustSupport" : true
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://example.com/fhir/hl7pt/StructureDefinition/address-pt"
            ]
          }
        ],
        "mustSupport" : true
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://example.com/fhir/hl7pt/StructureDefinition/PatientPrimaryCarePeriod-Pt"
            ]
          }
        ],
        "mustSupport" : true
