...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://example.com/fhir/hl7pt/StructureDefinition/birthplace-pt']) &lt;= 1">extension with URL = 'http://example.com/fhir/hl7pt/StructureDefinition/birthplace-pt': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://example.com/fhir/hl7pt/StructureDefinition/Notes-pt']) &lt;= 1">extension with URL = 'http://example.com/fhir/hl7pt/StructureDefinition/Notes-pt': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:address">
      ...
      <sch:assert test="count(f:extension[@url = 'http://example.com/fhir/hl7pt/StructureDefinition/address-pt']) &lt;= 1">extension with URL = 'http://example.com/fhir/hl7pt/StructureDefinition/address-pt': maximum cardinality of 'extension' is 1</sch:assert>
