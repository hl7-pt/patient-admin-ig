...
| Active as of 2026-03-03 | *Computable Name*:PTCoverageReason |

Extensão para codigo do motivo de isenção do utente .
...
```json
{
  ...
  "differential" : {
    "element" : [{
      ...
      "definition" : "Extensão para codigo do motivo de isenção do utente ."
    },
    {
