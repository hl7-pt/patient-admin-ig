...
| | |
| :--- | :--- |
| *Official URL*:http://example.com/fhir/example/CodeSystem/cs-fhir-events | *Version*:1.0.0 |
| Active as of 2025-12-03 | *Computable Name*:CS_FHIREvents |
...
Este case-sensitive sistema de código `http://example.com/fhir/example/CodeSystem/cs-fhir-events` define o seguinte códigos:
...
```json
{
  ...
  "id" : "cs-fhir-events",
  "url" : "http://example.com/fhir/example/CodeSystem/cs-fhir-events",
  "version" : "1.0.0",
  "name" : "CS_FHIREvents",
