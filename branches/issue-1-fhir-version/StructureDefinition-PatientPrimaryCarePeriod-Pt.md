...
| | |
| :--- | :--- |
| *Official URL*:http://example.com/fhir/example/StructureDefinition/PatientPrimaryCarePeriod-Pt | *Version*:1.0.0 |
| Active as of 2025-12-03 | *Computable Name*:PTPatientPrimaryCarePeriod |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        "id" : "Extension.url",
        "path" : "Extension.url",
        "fixedUri" : "http://example.com/fhir/example/StructureDefinition/PatientPrimaryCarePeriod-Pt"
      },
      {
