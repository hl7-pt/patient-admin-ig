...
| | |
| :--- | :--- |
| *Official URL*:http://example.com/fhir/example/StructureDefinition/Notes-pt | *Version*:1.0.0 |
| Active as of 2025-12-03 | *Computable Name*:PTNotes |
...
```json
{
  ...
  "id" : "Notes-pt",
  "url" : "http://example.com/fhir/example/StructureDefinition/Notes-pt",
  "version" : "1.0.0",
  "name" : "PTNotes",
  "status" : "active",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        "id" : "Extension.url",
        "path" : "Extension.url",
        "fixedUri" : "http://example.com/fhir/example/StructureDefinition/Notes-pt"
      },
      {
