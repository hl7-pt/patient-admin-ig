...
| | |
| :--- | :--- |
| *Official URL*:http://example.com/fhir/example/StructureDefinition/PersonRecordType-Pt | *Version*:1.0.0 |
| Active as of 2025-12-03 | *Computable Name*:PTPersonRecordType |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        "id" : "Extension.url",
        "path" : "Extension.url",
        "fixedUri" : "http://example.com/fhir/example/StructureDefinition/PersonRecordType-Pt"
      },
      {
