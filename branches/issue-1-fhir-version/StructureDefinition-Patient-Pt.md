...
| Active as of 2025-12-03 | *Computable Name*:PTPatient |
...
```json
{
  ...
  "differential" : {
    "element" : [
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://example.com/fhir/example/StructureDefinition/Notes-pt"
            ]
          }
        ],
        "mustSupport" : true
      ...
      {
        "id" : "Patient.address.extension:country-pt",
      ...
      {
        "id" : "Patient.address.extension:county-pt",
        "path" : "Patient.address.extension",
        "sliceName" : "county-pt",
        "min" : 0,
        "max" : "1",
      ...
      {
        "id" : "Patient.address.extension:municipality-pt",
        "path" : "Patient.address.extension",
      ...
      {
        "id" : "Patient.address.extension:parish-pt",
        "path" : "Patient.address.extension",
        "sliceName" : "parish-pt",
        "min" : 0,
        "max" : "1",
      ...
      {
        "id" : "Patient.contact.address.extension:country-pt",
      ...
      {
        "id" : "Patient.contact.address.extension:county-pt",
        "path" : "Patient.contact.address.extension",
        "sliceName" : "county-pt",
        "min" : 0,
        "max" : "1",
      ...
      {
        "id" : "Patient.contact.address.extension:municipality-pt",
        "path" : "Patient.contact.address.extension",
        "sliceName" : "municipality-pt",
        "min" : 0,
        "max" : "1",
      ...
      {
        "id" : "Patient.contact.address.extension:parish-pt",
        "path" : "Patient.contact.address.extension",
        "sliceName" : "parish-pt",
        "min" : 0,
        "max" : "1",
