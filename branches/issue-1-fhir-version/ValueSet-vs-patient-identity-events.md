...
| | |
| :--- | :--- |
| *Official URL*:http://example.com/fhir/example/ValueSet/vs-patient-identity-events | *Version*:1.0.0 |
| Active as of 2025-12-03 | *Computable Name*:VS_PatientIdentityEvents |
...
* Include estes códigos, tal como definidos em [`http://example.com/fhir/example/CodeSystem/cs-fhir-events`](CodeSystem-cs-fhir-events.md)versão 📦1.0.0

 

### Expansion

Expansão efectuada internamente com base em [codesystem FHIR Events CodeSystem v1.0.0 (CodeSystem)](CodeSystem-cs-fhir-events.md)
