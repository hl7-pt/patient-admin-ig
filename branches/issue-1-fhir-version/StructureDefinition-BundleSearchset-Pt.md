...
| | |
| :--- | :--- |
| *Official URL*:http://example.com/fhir/example/StructureDefinition/BundleSearchset-Pt | *Version*:1.0.0 |
| Active as of 2025-12-03 | *Computable Name*:PTBundleSearchset |
...
```json
{
  ...
  "url" : "http://example.com/fhir/example/StructureDefinition/BundleSearchset-Pt",
  "version" : "1.0.0",
