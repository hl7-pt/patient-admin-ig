...
| | |
| :--- | :--- |
| *Official URL*:http://example.com/fhir/example/StructureDefinition/BundleMessage-Pt | *Version*:1.0.0 |
| Active as of 2025-12-03 | *Computable Name*:PTBundleMessage |
...
```json
{
  ...
  "id" : "BundleMessage-Pt",
  "url" : "http://example.com/fhir/example/StructureDefinition/BundleMessage-Pt",
  "version" : "1.0.0",
