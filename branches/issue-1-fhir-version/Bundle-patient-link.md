# patient-link - HL7 PT FHIR Implementation Guide: Example IG Release 1 | STU1 v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **patient-link**

## Example Bundle: patient-link

Pacote patient-link do tipo message

-------

Entrada 1 - fullUrl = http://example.org/MessageHeader/96af02f3-5a9c-4220-8f62-ece462f2b4d3

Recurso MessageHeader:

> **event**: cs-fhir-events: PATIENT_LINK (Associação de registos de identificações de utente)
...
| :--- | :--- | :--- |
| - | **Name** | **Receiver** |
| * | EXTERNAL SYSTEM | [Unidade Local de Saúde Dev](http://example.org/fhir/Organization/70cfff33-ebcb-4f99-9bf5-c560575295d8) |

**sender**:[Unidade Local de Saúde Dev](http://example.org/fhir/Organization/70cfff33-ebcb-4f99-9bf5-c560575295d8)
...
Entrada 2 - fullUrl = http://example.org/Patient/21af15d4-7e31-3976-8391-ff0b3a4ab37d
...
Entrada 3 - fullUrl = http://example.org/Patient/17fafe5f-6ce2-3190-8eb0-9d2e80a4cbf6
...
Entrada 4 - fullUrl = http://example.org/Practitioner/cc5416a2-8697-3367-bba8-eec87f189664
...
```json
{
  ...
  "entry" : [
        ...
        "destination" : [
          {
            ...
            "receiver" : {
              "reference" : "http://example.org/fhir/Organization/70cfff33-ebcb-4f99-9bf5-c560575295d8",
    ...
    {
      "fullUrl" : "http://example.org/Patient/21af15d4-7e31-3976-8391-ff0b3a4ab37d",
      "resource" : {
    ...
    {
      "fullUrl" : "http://example.org/Patient/17fafe5f-6ce2-3190-8eb0-9d2e80a4cbf6",
      "resource" : {
        "resourceType" : "Patient",
    ...
    {
      "fullUrl" : "http://example.org/Practitioner/cc5416a2-8697-3367-bba8-eec87f189664",
      "resource" : {
