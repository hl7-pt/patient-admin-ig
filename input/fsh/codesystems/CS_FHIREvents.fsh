...
// ========================
// Eventos específicos de emergência
// ========================
* #EMERGENCY_UPDATE_TRIAGE "Atualização de triagem em emergência"
  * ^definition = "Atualização de dados do episódio de emergência durante a fase de triagem. HL7v2: ADT^A08 com Action Code 'T'."

* #EMERGENCY_UPDATE_PATIENT_CALL "Atualização chamada de utente em emergência"
  * ^definition = "Atualização de dados do episódio de emergência na fase de chamada do utente. HL7v2: ADT^A08 com Action Code 'CP'."
