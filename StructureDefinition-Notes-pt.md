...
| Active as of 2026-02-13 | *Computable Name*:PTNotes |

Extensão para notas relativas ao registo do utente.
...
```json
{
  ...
  "description" : "Extensão para notas relativas ao registo do utente.",
  "jurisdiction" : [
    {
      "coding" : [
        {
    ...
    "element" : [
      {
        "id" : "Extension",
        "path" : "Extension",
        "definition" : "Extensão para notas relativas ao registo do utente."
      },
      {
