...
Extensão para registo de escolaridade do utente.
...
```json
{
  ...
  "description" : "Extensão para registo de escolaridade do utente.",
  "jurisdiction" : [
    {
      "coding" : [
        {
    ...
    "element" : [
      {
        "id" : "Extension",
        "path" : "Extension",
        "definition" : "Extensão para registo de escolaridade do utente."
      },
      {
        "id" : "Extension.url",
        "path" : "Extension.url",
